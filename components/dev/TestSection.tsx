      ...
      <div className="navbar bg-base-200 border-primary/20 mb-8 rounded-lg border">
        ...
        <div className="navbar-end">
          <div className="flex items-center gap-3">
            <div className="badge badge-primary">{currentTheme.label}</div>
          </div>
        </div>
      </div>
      ...
      <div className="tabs tabs-boxed bg-base-200 mb-6">
        {['overview', 'calculator', 'materials', 'account', 'components'].map((tab) => (
          <button
            ...
            className={`tab tab-md ${activeTab === tab ? 'tab-active' : ''}`}
          >
    ...
    <div className="space-y-6">
        ...
        <div className="hero-content py-16 text-center">
          <div className="max-w-2xl">
            ...
            <Image
              ...
              src="/logo.png"
              alt="Additive3D Logo"
              className="mx-auto mb-8 h-22 w-70 object-contain"
            />
            <h2 className="mb-4 text-4xl font-bold">Precision Manufacturing Excellence</h2>
            <p className="mb-6 text-lg opacity-80">
              Transform your digital designs into high-precision physical parts with our advanced
              additive manufacturing solutions
            </p>
            <button className="btn btn-primary btn-lg">Get Instant Quote</button>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
        {[
          ...
          <div key={idx} className="card bg-base-200 border-primary/20 border shadow-xl">
    ...
    <div className="mx-auto max-w-2xl">
      <div className="card bg-base-200 shadow-xl">
        <div className="card-body">
          ...
          {/* Upload Area */}
          <div className="border-primary mb-6 rounded-lg border-2 border-dashed p-10 text-center">
            <p className="mb-4">Drop your 3D model files here</p>
            <button className="btn btn-primary">Browse Files</button>
          </div>

          {/* Cost Breakdown */}
          <div className="bg-base-100 mb-6 rounded-lg p-5">
              ...
              {[
                ...
                <div
                  ...
                  className={`flex items-center justify-between py-2 ${
                    idx > 0 ? 'border-base-300 border-t' : ''
                  }`}
                >
                  <span className={line.bold ? 'font-bold' : 'font-normal'}>{line.item}</span>
                  <span className={`${line.bold ? 'text-primary font-bold' : 'font-normal'}`}>
                    {line.amount}
                  </span>
                </div>
              ))}
          ...
          <div className="flex gap-4">
            <button className="btn btn-primary flex-1">Proceed to Order</button>
            <button className="btn btn-outline flex-1">Save Quote</button>
          </div>
        </div>
      </div>
    </div>
...
function MaterialsSection() {
  return (
    <div>
      <h2 className="mb-6 text-2xl font-bold">Material Specifications</h2>

      {/* Material Comparison Table */}
      <div className="card bg-base-200 overflow-x-auto shadow-xl">
          ...
          <table className="table-zebra table w-full">
            <thead>
              <tr className="border-primary border-b-2">
                ...
                <th className="p-3 text-left">Cost/kg</th>
              </tr>
            </thead>
            <tbody>
              {[
        ...
        <div className="card bg-base-200 shadow-xl">
          <div className="card-body">
            ...
            <Image
              ...
              src="/logo.png"
              alt="Additive3D Logo"
              className="mx-auto mb-6 h-11 w-35 object-contain"
            />
            <h3 className="card-title mb-5 text-center">Account Menu</h3>
          ...
          <div className="card-body">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={idx} className="card bg-base-100 border-primary/20 border">
        ...
        <div className="card-body">
          ...
          <div className="space-y-4">
            ...
            <div className="form-control">
              ...
              <select className="select select-bordered h-24 w-full" multiple>
